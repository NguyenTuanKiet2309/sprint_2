            ...
            <div className="card card-registration card-registration-2" style={{borderRadius: '15px'}}>
              <div className="card-body p-0">
                <div className="row g-0">
                    ...
                    <div className="p-5">
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        <div className="col-md-2 col-lg-2 col-xl-2">
                          <img src={image1} className="img-fluid rounded-3" alt="Cotton T-shirt" />
                        </div>
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                          <h6 className="mb-0">344.000.000 VNĐ</h6>
                        </div>
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        <div className="col-md-2 col-lg-2 col-xl-2">
                          <img src={image2} className="img-fluid rounded-3" alt="Cotton T-shirt" />
                        </div>
                        <div className="col-md-3 col-lg-3 col-xl-3">
                          <h6 className="text-muted">Rolex</h6>
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                          <h6 className="mb-0">550.000.000 VNĐ</h6>
                        </div>
                        <div className="col-md-1 col-lg-1 col-xl-1 text-end">
                          <a href="#!" className="text-muted"><i className="fas fa-times" /></a>
                        </div>
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        <div className="col-md-2 col-lg-2 col-xl-2">
                          <img src={image3} className="img-fluid rounded-3" alt="Cotton T-shirt" />
                        </div>
                        <div className="col-md-3 col-lg-3 col-xl-3">
                          <h6 className="text-muted">Rolex</h6>
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                          <h6 className="mb-0">280.000.000 VNĐ</h6>
                        </div>
                        <div className="col-md-1 col-lg-1 col-xl-1 text-end">
                          <a href="#!" className="text-muted"><i className="fas fa-times" /></a>
                        </div>
                  ...
                  <div className="col-lg-4 bg-grey" style={{borderRadius: "0px 15px 15px 0px"}}>
                    <div className="p-5">
                      ...
                      <div className="mb-4 pb-2">
                        <select className="select">
                          <option value={1}>Standard-Delivery- 10.000.000 VNĐ</option>
