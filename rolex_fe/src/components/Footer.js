...
import envelope from "../envelope-white.png";
import location from "../location-white.png";
import telephone from "../telephone-white.png";
export default function Footer() {
  return (
    <>
      <section
        className="info_section layout_padding2"
        style={{ backgroundColor: "#145f3d" }}
      >
        <div className="container">
          <div className="info_logoo">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="info_info">
                <h5>Giới Thiệu</h5>
                <p>
                  Rolex World là một trang web bán đồng hồ chuyên nghiệp và đáng
                  tin cậy, tập trung vào việc cung cấp các sản phẩm đồng hồ
                  Rolex chính hãng. Với sự đam mê và kiến thức sâu sắc về ngành
                  đồng hồ, chúng tôi tự hào là địa chỉ đáng tin cậy cho những
                  người yêu thích thương hiệu Rolex.
                  Hãy khám phá Rolex World và khám phá thế giới của những chiếc đồng hồ Rolex tuyệt vời ngay hôm nay!
                </p>
              </div>
            </div>
            <div className="col-md-3">
