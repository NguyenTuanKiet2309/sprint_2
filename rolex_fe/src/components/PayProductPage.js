    ...
    Swal.fire({
      ...
      if (res.isConfirmed) {
        if (
          ...
          localStorage.setItem("idProduct", param.productId);
          localStorage.setItem("code", 1);
          const data = await payWithVNpay(products.price);
                  ...
                  <div>
                    <div className="row">
                      ...
                      <div className=" col-3">
                        ...
                        <br />
                        <div>{products.productCode}</div>
                      </div>
                      <span className="price col-6">
                        <div style={{ float: "right" }}>
                          <CurrencyFormat value={products.price} /> VNĐ
                        </div>
                        <div>x 1</div>
                        <hr />
                      </span>
